...
class ApiService {
  ...
  static Future<void> initNotifications() async {
    ...
    const channel = AndroidNotificationChannel(
      ...
      description: 'Alertes en temps r├®el lors d\'un but',
  ...
  static Future<List<LiveMatch>> fetchLiveMatches() async {
    try {
      ...
      debugPrint('ÔÜá´©Å fetchLiveMatches: timeout, returning empty list');
    } on http.ClientException catch (e) {
      debugPrint('ÔÜá´©Å fetchLiveMatches: network issue ($e), returning empty list');
    } catch (e) {
      debugPrint('ÔØî fetchLiveMatches Error: $e');
    }
    return [];
  }
  ...
  static Future<void> _showGoalNotification(LiveMatch m) async {
    ...
    await _notifications.show(m.id.hashCode, 'ÔÜ¢ BUT !!!', '${m.homeTeam} ${m.scoreHome} - ${m.scoreAway} ${m.awayTeam}', details);
  }
  ...
  static Future<List<LiveMatch>> fetchMatches({int? year}) async {
    ...
    } catch (e) { debugPrint('ÔØî fetchMatches Error: $e'); }
    return [];
  }
  ...
  static Future<List<GroupStanding>> fetchStandings({int? year}) async {
    ...
    } catch (e) { debugPrint('ÔØî fetchStandings Error: $e'); }
    return [];
  }

  static Future<MatchDetails?> fetchFullMatchDetails(String fixtureId, {int? year}) async {
    try {
      // Pour les d├®tails, on utilise la route unique /api/match/id
    ...
    } catch (e) { debugPrint('ÔØî fetchFullMatchDetails Error: $e'); }
    return null;
  }
  ...
  static Future<TeamProfile?> fetchTeamProfile({required int teamId, String? teamName, int? year}) async {
    try {
      ...
      return TeamProfile(
        id: teamId, name: teamName ?? '├ëquipe', shortName: teamName ?? '├ëquipe',
    ...
    } catch (e) { debugPrint('ÔØî fetchTeamProfile Error: $e'); }
    return null;
  }
  ...
  static Future<Map<String, dynamic>?> fetchPlayerStats({required int playerId, int? season}) async {
    ...
    } catch (e) { debugPrint('ÔØî fetchPlayerStats Error: $e'); }
    return null;
  }
  ...
  static Future<List<TopScorer>> fetchTopScorers({int? year}) async {
    ...
    } catch (e) { debugPrint('ÔØî fetchTopScorers Error: $e'); }
    return [];
  }
  ...
  static Future<List<dynamic>> fetchNews() async {
    ...
    } catch (e) { debugPrint('ÔØî fetchNews Error: $e'); }
    return [];
  }
  ...
  static Future<List<dynamic>> fetchVenues() async {
    ...
    } catch (e) { debugPrint('ÔØî fetchVenues Error: $e'); }
    return [];
  }
  ...
  static Future<Map<String, dynamic>?> fetchCupTree() async {
    ...
    } catch (e) { debugPrint('ÔØî fetchCupTree Error: $e'); }
    return null;
  }
  ...
  static Future<List<dynamic>> fetchPowerRankings() async {
    ...
    } catch (e) { debugPrint('ÔØî fetchPowerRankings Error: $e'); }
    return [];
  }
  ...
  static String _formatMonthName(DateTime d) => ['Jan', 'F├®v', 'Mar', 'Avr', 'Mai', 'Juin', 'Juil', 'Ao├╗', 'Sep', 'Oct', 'Nov', 'D├®c'][d.month - 1];
}
