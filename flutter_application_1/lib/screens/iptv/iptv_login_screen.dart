...
const _kTabLabels   = ['Xtream', 'M3U URL', 'ID', 'Code'];
const _kTabTitles   = ['Xtream Codes', 'Playlist M3U', 'Playlist ID', 'Code Rapide'];
...
class _IptvLoginScreenState extends State<IptvLoginScreen>
  ...
  String _errorMsg() => switch (_tab) {
        0 => 'Connexion échouée — vérifiez vos identifiants',
        1 => 'URL invalide ou playlist inaccessible',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        // Halos d'ambiance
        _glow(top: -60,   left: -40,  size: 220, color: _kGold.withValues(alpha: 0.12)),
        _glow(bottom: -40, right: -40, size: 160, color: _kGold.withValues(alpha: 0.08)),
            ...
            child: Column(
              ...
              children: [
                ...
                Text('LIVE TV', style: TextStyle(
                  ...
                  letterSpacing: 4, color: _kGold,
                  shadows: [Shadow(color: _kGold.withValues(alpha: 0.35), blurRadius: 14)],
                )),
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    const SizedBox(height: 6),
                    Divider(color: _kGold.withValues(alpha: 0.1), height: 24),
        ...
        children: [
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(_kTabTitles[_tab], style: const TextStyle(
                color: _kGold, fontSize: 14,
                fontWeight: FontWeight.w800, letterSpacing: 0.2,
              )),
              const SizedBox(height: 2),
              Text(_kTabSubtitles[_tab], style: TextStyle(
  ...
  Widget _buildFormContent({
    ...
    required bool isDark,
        ...
        0 => _buildXtreamForm(fieldBg, hintColor, textColor),
        1 => _buildM3uForm(fieldBg, hintColor, textColor),
  ...
  Widget _buildXtreamForm(Color fieldBg, Color hintColor, Color textColor) {
    return Column(children: [
      _field(
        ctrl: _serverCtrl, label: 'Serveur',
        hint: 'http://server.com:8080',
        icon: Icons.dns_rounded,
        fieldBg: fieldBg, hintColor: hintColor, textColor: textColor,
        keyboard: TextInputType.url,
      ),
      const SizedBox(height: 14),
      _field(
        ctrl: _userCtrl, label: 'Utilisateur',
        hint: 'username',
      ...
      const SizedBox(height: 14),
      _field(
        ctrl: _passCtrl, label: 'Mot de passe',
        hint: '••••••••',
        ...
        suffix: IconButton(
          icon: Icon(
            ...
            color: _kGold.withValues(alpha: 0.6), size: 20,
          ),
  ...
  Widget _buildM3uForm(Color fieldBg, Color hintColor, Color textColor) {
    return Column(children: [
      _field(
        ctrl: _m3uCtrl, label: 'URL Playlist',
  ...
  Widget _buildPlaylistIdForm(Color fieldBg, Color hintColor, Color textColor) {
    return Column(children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(14),
              borderSide: BorderSide(color: _kGold.withValues(alpha: 0.6), width: 2),
            ),
          ),
        ),
      ]),
      ...
      // Serveur IPTV
      _field(
        ctrl: _plServerCtrl, label: 'Serveur IPTV',
      ...
      _infoBox(
        ...
        lines: [
          ...
          ('Votre fournisseur IPTV vous attribue un numéro de playlist (ex : 182, 2014, 1205). Entrez ce numéro et le domaine de votre fournisseur.', false),
        ],
      ),
    ]);
  }
  ...
  Widget _buildQuickCodeForm(Color fieldBg, Color hintColor, Color textColor) {
    return Column(children: [
      _field(
        ctrl: _codeCtrl, label: 'Code de partage',
      ...
      _infoBox(
        ...
        lines: [
          ...
          ('Connectez-vous via Xtream Codes puis appuyez sur "Partager Code" dans l\'écran des catégories.', false),
        ],
      ),
    ]);
  }
  ...
  Widget _buildConnectBtn() => SizedBox(
    ...
    child: ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        elevation: 8, shadowColor: _kGold.withValues(alpha: 0.4),
      ),
      onPressed: _loading ? null : _connect,
      child: _loading
          ? const SizedBox(width: 24, height: 24,
              child: CircularProgressIndicator(strokeWidth: 2.5, color: _kDarkBg))
  ...
  Widget _label(String text) => Text(
    text.toUpperCase(),
    style: TextStyle(
      color: _kGold.withValues(alpha: 0.72), fontSize: 11,
  ...
  Widget _pasteBtn(TextEditingController ctrl) => IconButton(
    icon: Icon(Icons.content_paste_rounded,
        color: _kGold.withValues(alpha: 0.65), size: 20),
    onPressed: () async {
          ...
          child: Column(
            ...
            children: lines.map((e) => Padding(
              ...
              child: Text(e.$1, style: TextStyle(
                ...
                fontSize: e.$2 ? 12 : 11,
                fontWeight: e.$2 ? FontWeight.w700 : FontWeight.normal,
                height: 1.5,
              )),
            )).toList(),
          ),
