...
class NationFlagBadge extends StatelessWidget {
  ...
  static String? resolveFlagUrl(String countryCode, [String? imageUrlOverride]) {
  ...
  static String? _resolveByTeamName(String name) {
    const nameMap = {
      ...
      'brazil': 'br', 'bulgaria': 'bg', 'burkina': 'bf', 'burundi': 'bi',
      ...
      'trinidad': 'tt', 'tunisia': 'tn', 'turkey': 'tr', 'turkiye': 'tr',
      'uganda': 'ug', 'ukraine': 'ua', 'united arab emirates': 'ae', 'uae': 'ae',
      'united states': 'us', 'usa': 'us', 'uruguay': 'uy', 'uzbekistan': 'uz',
      'venezuela': 've', 'vietnam': 'vn', 'wales': 'gb-wls', 'yemen': 'ye',
      'zambia': 'zm', 'zimbabwe': 'zw', 'ivory coast': 'ci', 'côte d\'ivoire': 'ci',
      'cape verde': 'cv', 'el salvador': 'sv', 'equatorial guinea': 'gq',
      'trinidad and tobago': 'tt', 'new caledonia': 'nc',
    };
