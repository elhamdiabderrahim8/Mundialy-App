...
urls = {
    ...
    "QF": "https://api.sofascore.com/api/v1/unique-tournament/16/season/41087/events/round/27/slug/quarterfinals",
    "SF": "https://api.sofascore.com/api/v1/unique-tournament/16/season/41087/events/round/28/slug/semifinals",
    "3rd": "https://api.sofascore.com/api/v1/unique-tournament/16/season/41087/events/round/50/slug/match-for-3rd-place",
...
try:
    for name, url in urls.items():
        ...
        if 'events' in data and len(data['events']) > 0:
            ...
            print(f"  [FAILED] No events found for {name} URL: {url}")
finally:
    driver.quit()
